...
interact_fields['id_categoria'] = '';
interact_fields['id_alimento'] = '';
...
function loadCategorias() {
    ...
    formData.append('action', "CategoriaCardapio");
...
function loadAlimentos() {
    ...
    formData.append('action', "CategorizarAlimento");

    formData.append('method', "getByIdCategoria");
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.count) {
                ...
                $.each(data.result, function (key, value) {
                    option += '<option value="' + value.id_alimento + '" >' + value.alimento + '</option>';
                });

                $("#id_alimento").html(option);
...
function create(formData) {
    ...
    formData.append('action', "Cardapio");
