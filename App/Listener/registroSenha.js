            ...
            if (data.count) {
                ...
                $.each(data.result, function (key, value) {
                    ...
                    tbody += '<tr>' +
                        ...
                        '<td width="60%">' + value.servico + '</td>' +
                        '<td width="60%">' + value.usuario + '</td>' +
                        '<td width="60%">' + value.senha + '</td>' +
...
function create(formData) {
    ...
    formData.append('action', "RegistroSenha");
