...
interact_fields['id'] = '';
interact_fields['codigo'] = '';
interact_fields['produto'] = '';
interact_fields['id_unidade'] = '';
        ...
        data: {
            ...
            if (data.count) {
                ...
                $.each(data.result, function (key, value) {
                    ...
                    tbody += '<tr>' +
                        '<td width="60%">' + value.codigo + '</td>' +
                        '<td width="60%">' + value.produto + '</td>' +
                        '<td width="60%">' + value.unidade + '</td>' +
