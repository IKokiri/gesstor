    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"> Aplicação </h4>
            </div>
            <div class="modal-body">
                ...
                <form class="form-horizontal form-label-left input_mask" id="form-principal" method='POST'
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="aplicacao"
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="alias"
                               placeholder="Alias">
                        <span class="fa fa-envelope form-control-feedback left" aria-hidden="true"></span>
