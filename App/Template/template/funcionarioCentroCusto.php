<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2> Centro de Custos de Funcionários </h2>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"> Adicionar Funcionário ao centro de Custo </h4>
            </div>
            <div class="modal-body">
                ...
                <form class="form-horizontal form-label-left input_mask" id="form-principal" method='POST'
                    ...
                    <div class="checkbox col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <label>
                            <input type="checkbox" class="flat" checked="checked" id="gerente_centro_custo"> Gerente Do Centro de Custo
                        </label>
                    </div>
                    <div class="checkbox col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <label>
