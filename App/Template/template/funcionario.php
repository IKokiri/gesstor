<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <table id="table_principal" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
          width="100%">
          <thead>
            <tr>
              <th>Funcionario</th>
          ...
          <div id="wizard_verticle" class="form_wizard wizard_horizontal">
            ...
            <div id="step-1">
              <form class="form-horizontal form-label-left input_mask">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                  ...
                  <div id="gender" class="btn-group" data-toggle="buttons">
                    <label class="btn btn-default" data-toggle-class="btn-primary"
                      ...
                      <input type="radio" class='pessoa_tipo' id='tipo_pessoa' name="tipo_pessoa" value="Física"
                        data-parsley-multiple="tipo_pessoa">Física
                    </label>
                    <label class="btn btn-primary" data-toggle-class="btn-primary"
                      data-toggle-passive-class="btn-default">
                      <input type="radio" class='pessoa_tipo' id='tipo_pessoa' name="tipo_pessoa" value="Jurídica"
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback fisica">
                  <label>Sigla:</label>
                  <input type="text" class="form-control has-feedback-left" id="sigla" placeholder="Sigla">
                  <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback juridica">
                  ...
                  <input type="text" class="form-control has-feedback-left" id="fantasia" placeholder="Fantasia">
                  <span class="fa fa-industry form-control-feedback left" aria-hidden="true"></span>
                </div>

                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback fisica">
                  <label>RG:</label>
                  <input type="text" class="form-control has-feedback-left" id="rg" placeholder="rg">
                  <span class="fa fa-book form-control-feedback left" aria-hidden="true"></span>
                </div>

                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback fisica">
                  <label>CPF:</label>
                  <input type="text" class="form-control has-feedback-left mask_cpf" id="cpf" placeholder="CPF">
                  <span class="fa fa-credit-card form-control-feedback left" aria-hidden="true"></span>
                </div>

                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback juridica">
                  <label>IE:</label>
                  <input type="text" class="form-control has-feedback-left" id="ie" placeholder="ie">
                  <span class="fa fa-industry form-control-feedback left" aria-hidden="true"></span>
                </div>

                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback juridica">
                  <label>CNPJ:</label>
                  <input type="text" class="form-control has-feedback-left mask_cnpj" id="cnpj" placeholder="CNPJ">
                  <span class="fa fa-industry form-control-feedback left" aria-hidden="true"></span>
                </div>
            ...
            <div id="step-2">
              <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback row-fluid row">
                <label>CEP:</label>
                <input type="text" class="form-control has-feedback-left mask_cep" id="cep" placeholder="CEP">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback row-fluid row">
                <label>Rua:</label>
                <input type="text" class="form-control has-feedback-left" id="rua" placeholder="Rua">
                <span class="fa fa-street-view form-control-feedback left" aria-hidden="true"></span>
              </div>

              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback row-fluid row">
                <label>Nº:</label>
                <input type="text" class="form-control has-feedback-left" id="numero" placeholder="Nº">
                <span class="fa fa-street-view form-control-feedback left" aria-hidden="true"></span>
              </div>

              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback row-fluid row">
                <label>Bairro:</label>
                <input type="text" class="form-control has-feedback-left" id="bairro" placeholder="Bairro">
                <span class="fa fa-street-view form-control-feedback left" aria-hidden="true"></span>
              </div>

              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback row-fluid row">
                <label>Cidade:</label>
                <input type="text" class="form-control has-feedback-left" id="cidade" placeholder="Cidade">
                <span class="fa fa-street-view form-control-feedback left" aria-hidden="true"></span>
              </div>

              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback row-fluid row">
                <label>UF:</label>
                <input type="text" class="form-control has-feedback-left" id="uf" placeholder="UF">
                <span class="fa fa-street-view form-control-feedback left" aria-hidden="true"></span>
              </div>
            </div>
            <div id="step-3">
              <div class="col-md-6 col-sm-6 col-xs-6 form-group has-feedback row-fluid row">
                <label>CNH</label>
                <input type="text" class="form-control has-feedback-left" id="cnh" placeholder="CNH">
                <span class="fa fa-street-view form-control-feedback left" aria-hidden="true"></span>
              </div>

              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback row-fluid row">
                <label>Categoria:</label>
                <input type="text" class="form-control has-feedback-left" id="categoriaCNH" placeholder="Categoria">
                <span class="fa fa-street-view form-control-feedback left" aria-hidden="true"></span>
              </div>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback row-fluid row">
                ...
                <input type="text" class="form-control has-feedback-left mask_data" id="validadeCNH" placeholder="Validade">
                <span class="fa fa-street-view form-control-feedback left" aria-hidden="true"></span>
              </div>
            </div>
            <div id="step-4">
              <div class="col-md-6 col-sm-6 col-xs-6 form-group has-feedback row-fluid row">
                <label>validade:</label>
                <input type="text" class="form-control has-feedback-left" id="email" placeholder="E-Mail">
                <span class="fa fa-street-view form-control-feedback left" aria-hidden="true"></span>
              </div>

              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback row-fluid row">
                <label>Senha:</label>
                <input type="password" class="form-control has-feedback-left" id="senha" placeholder="SENHA">
                <span class="fa fa-street-view form-control-feedback left" aria-hidden="true"></span>
              </div>
            </div>
...
<div class="modal fade modal_servicos" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal form-label-left input_mask" id="form-servicos-cliente" method='POST'
          enctype="multipart/form-data">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback row-fluid row">
            <label>Valor:</label>
            <input type="text" class="form-control has-feedback-left mask_money" id="valor_servico" placeholder="Valor">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="modal_servicos_area">Serviços do Funcionario</h4>
      </div>
      <div class="modal-body">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="modal_servicos_area">Contatos do Funcionario</h4>
      </div>
      <div class="modal-body">
...
<div class="modal fade modal_add_contatos" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal form-label-left input_mask" id="form-contatos" method='POST'
          enctype="multipart/form-data">

          <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback row-fluid row">
            <label>Nome:</label>
            <input type="text" class="form-control has-feedback-left" id="nome_contato" placeholder="Nome">
            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
          </div>
          <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback row-fluid row">
            <label>Sobrenome:</label>
            <input type="text" class="form-control has-feedback-left" id="sobrenome_contato" placeholder="Sobrenome">
            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
          </div>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback row-fluid row">
            <label>E-Mail</label>:
            <input type="text" class="form-control has-feedback-left" id="email_contato" placeholder="E-Mail">
