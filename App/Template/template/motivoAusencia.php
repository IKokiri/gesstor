    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"> Motivo Ausencia </h4>
            </div>
            <div class="modal-body">
                ...
                <form class="form-horizontal form-label-left input_mask" id="form-principal" method='POST'
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="ausencia"
                               placeholder="Ausência">
