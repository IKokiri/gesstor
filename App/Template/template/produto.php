            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal form-label-left input_mask" id="form-principal" method='POST'
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="codigo"
                               placeholder="Código">
                        <span class="fa fa-envelope form-control-feedback left" aria-hidden="true"></span>
                    </div>
                    <div class="form-group col-md-6 col-sm-6 col-xs-6">
                        <label>Unidade:</label>
                        <select class="select2_single form-control" id="id_unidade">
                        </select>
                    </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                        ...
                        <input type="text" class="form-control has-feedback-left" id="produto"
                               placeholder="Produto">
                        <span class="fa fa-envelope form-control-feedback left" aria-hidden="true"></span>
                    </div>
