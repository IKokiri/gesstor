...
require_once MODEL . DS . 'Representante.php';
require_once VIEW . DS . 'Representante.php';

use App\Core\Controller;
use App\Core\Model;
use App\Model\Representante as Representante_Model;
use App\View\Representante as Representante_View;
...
class Representante extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->oModel = new Representante_Model();

        $this->oView = new Representante_View();
    }
