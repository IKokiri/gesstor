...
require_once MODEL . DS . 'Tabela.php';
require_once VIEW . DS . 'Tabela.php';

use App\Core\Controller;
use App\Core\Model;
use App\Model\Tabela as Tabela_Model;
use App\View\Tabela as Tabela_View;
...
class Tabela extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->oModel = new Tabela_Model();

        $this->oView = new Tabela_View();
    }
