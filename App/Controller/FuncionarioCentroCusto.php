...
require_once VIEW . DS . 'FuncionarioCentroCusto.php';

use App\Core\Controller;
use App\Core\Model;
use App\Model\FuncionarioCentroCusto as FuncionarioCentroCusto_Model;
use App\View\FuncionarioCentroCusto as FuncionarioCentroCusto_View;

class FuncionarioCentroCusto extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->oModel = new FuncionarioCentroCusto_Model();

        $this->oView = new FuncionarioCentroCusto_View();
    }
