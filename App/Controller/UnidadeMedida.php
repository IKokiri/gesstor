...
require_once MODEL . DS . 'UnidadeMedida.php';
require_once VIEW . DS . 'UnidadeMedida.php';

use App\Core\Controller;
use App\Core\Model;
use App\Model\UnidadeMedida as UnidadeMedida_Model;
use App\View\UnidadeMedida as UnidadeMedida_View;
...
class UnidadeMedida extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->oModel = new UnidadeMedida_Model();

        $this->oView = new UnidadeMedida_View();
    }
