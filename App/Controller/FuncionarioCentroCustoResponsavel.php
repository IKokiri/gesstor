...
require_once VIEW . DS . 'FuncionarioCentroCustoResponsavel.php';

use App\Core\Controller;
use App\Core\Model;
use App\Model\FuncionarioCentroCustoResponsavel as FuncionarioCentroCustoResponsavel_Model;
use App\View\FuncionarioCentroCustoResponsavel as FuncionarioCentroCustoResponsavel_View;

class FuncionarioCentroCustoResponsavel extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->oModel = new FuncionarioCentroCustoResponsavel_Model();

        $this->oView = new FuncionarioCentroCustoResponsavel_View();
    }
