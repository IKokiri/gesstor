...
class Faixa extends Model
{
    ...
    {
        $this->validator->set('Faixa', $this->faixa)->is_required();
        ...
        $query->bindValue(':faixa', $this->faixa, PDO::PARAM_STR);
