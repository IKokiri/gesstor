...
class AjusteHoras extends Model
{
    private $table = 'ajustes_horas';
    ...
    public function getAllDetalhado()
    {
        ...
        $sql = "select * from ajustes_horas where data >= :data_inicio and data <= :data_fim";
