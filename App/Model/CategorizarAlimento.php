...
class CategorizarAlimento extends Model
{
    private $table = 'categoria_alimentos';
    ...
    {
        $this->validator->set('Categoria', $this->id_categoria)->is_required();
    ...
    public function getByIdCategoria()
    {
        ...
        $sql = "SELECT T1.*,T2.categoria,T3.alimento FROM " . $this->table. " T1 " .
            ...
            " on T1.id_categoria = T2.id " .
            " inner join alimentos T3" .
            " on T1.id_alimento = T3.id where T1.id_categoria = :id_categoria";
